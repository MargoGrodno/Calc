...
describe('Calculation using Reverse Polish Notation', function() {
    ...
    describe('Synchronous call', function() {
        ...
        describe('Errors', function() {
            ...
            it('(2-3)) ---> incorrect expression: brackets error', function() {
                expect(function() {
                    rpn.calculator('(2-3))');
                }).to.throw('incorrect expression: brackets error');
            });
            it(')(2-3 ---> incorrect expression: brackets error', function() {
                expect(function() {
                    rpn.calculator('(2-3))');
            ...
            it('sqrt+5 ---> incorrect use of embedded method', function() {
                ...
                }).to.throw('incorrect use of embedded method');
            });
            it('sqrt(4+5 ---> incorrect use of embedded method', function() {
                expect(function() {
                    rpn.calculator('sqrt(4+5');
                }).to.throw('incorrect use of embedded method');
            });
        });
    });
    ...
    describe('Asynchronous call', function() {
        ...
        describe('General expressions', function() {
            ...
            it('12+9 ---> 21', function(done) {
                rpn.calculatorA('12+9', function(res) {
            ...
            it('(6+8)/7*6 ---> 12', function(done) {
                rpn.calculatorA('(6+8)/7*6', function(res) {
            ...
            it('(14+22*((5-3+1*0+0*1))) ---> 58', function(done) {
                rpn.calculatorA('(14+22*((5-3+1*0+0*1)))', function(res) {
            ...
            it('1*(0+0+3+0)+90807 ---> 90810', function(done) {
                rpn.calculatorA('1*(0+0+3+0)+90807', function(res) {
            ...
            it('33/0 ---> Infinity', function(done) {
                rpn.calculatorA('33/0', function(res) {
        ...
        describe('Unary minus', function() {
            it('-(-(1-2)) -----> -1', function(done) {
                rpn.calculatorA('-(-(1-2))', function(res) {
            ...
            it('56-(-(1-2)+2) -----> 53', function(done) {
                rpn.calculatorA('56-(-(1-2)+2)', function(res) {
            ...
            it('-(1-2)*(5+6/(3-2)) -----> 11', function(done) {
                rpn.calculatorA('-(1-2)*(5+6/(3-2))', function(res) {
        ...
        describe('Variables', function() {
            it('t+h -----> 4', function(done) {
                rpn.calculatorA('t+h', function(res) {
            ...
            it('djfh+1 -----> 3', function(done) {
                rpn.calculatorA('djfh+1', function(res) {
            ...
            it('var-(-(1-var1)+var2) -----> -1', function(done) {
                rpn.calculatorA('var-(-(1-var1)+var2)', function(res) {
                    expect(res).to.equal(-1);
                    done();
                }, function(str) {
                    console.log(str);
        ...
        describe('Embedded Methods', function() {
            ...
            it('15-sum(2,3,4,1,1,1) -----> 3', function(done) {
                rpn.calculatorA('15-sum(2,3,4,1,1,1)', function(res) {
                    expect(res).to.equal(3);
                    done();
                }, function(str) {
                    console.log(str);
            ...
            it('-sum(2,13-2*5) -----> -5', function(done) {
                rpn.calculatorA('-sum(2,13-2*5)', function(res) {
            ...
            it('sum(5,sum(6,5),8,sum(4,sum(3,7),5)) -----> 43', function(done) {
                rpn.calculatorA('sum(5,sum(6,5),8,sum(4,sum(3,7),5))', function(res) {
            ...
            it('aaverage(5,7,9)+factorial(4)+(gaverage(6,24)+6)/(5+mult(1,2*2)) -----> 33', function(done) {
                rpn.calculatorA('aaverage(5,7,9)+factorial(4)+(gaverage(6,24)+6)/(5+mult(1,2*2))', function(res) {
        ...
        describe('Embedded Methods & Variables', function() {
            it('sum(2,13-var*5) -----> 5', function(done) {
                rpn.calculatorA('sum(2,13-var*5)', function(res) {
                    expect(res).to.equal(5);
                    done();
                }, function(str) {
                    console.log(str);
            ...
            it('10-sum(var,1) -----> 7', function(done) {
                rpn.calculatorA('10-sum(var,1)', function(res) {
